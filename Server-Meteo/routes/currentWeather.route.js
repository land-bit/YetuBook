...
/**
 * @swagger
 * /currentweatherhistory?date=30-Juillet-2024:
 *    get:
 *      summary: Ce chemin rammène tous les données météorologique d'une date du passé
 *      tags: [Weather data history]
 *      responses:
 *        '200':
 *          description: Succès
 *          content:
 ...
 *                      type: array
 *                      items: 
 *                          $ref: '#/components/schemas/Weather History' 
 *          '500':
